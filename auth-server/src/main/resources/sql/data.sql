...
SELECT *
FROM (SELECT 'admin', 'admin@admin.com', '$2a$10$r0RFDmpneBVryx.ihHK9gu6FFJQi4nTxQUqzdSTvrPpaKZMxigqpy', true) AS tmp
...
SELECT *
FROM (SELECT 'admin', 'ROLE_USER') AS tmp
WHERE NOT EXISTS(
...
INSERT INTO user_authority (username, authority)
SELECT *
FROM (SELECT 'admin', 'ROLE_ADMIN') AS tmp
WHERE NOT EXISTS(
